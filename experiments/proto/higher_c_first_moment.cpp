// Exact FIRST moment sum(m * ell * F), NOT N(C) = sum(m * ell * F^2).
// Retained from the audited 2026-07-15 histogram prototype, without changes
// to its arithmetic or recurrence. Limited to C <= 6; no higher-C speedup
// is asserted. Build/reproduction instructions: docs/math/higher-c-structure.md.
#include <algorithm>
#include <array>
#include <cassert>
#include <cstdint>
